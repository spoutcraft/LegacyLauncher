...
What is Launcher?
-----------------
Launcher is the custom launcher for installing and updating Spoutcraft with built-in byte patching for easy upgrading/downgrading of Minecraft versions.

Copyright (c) 2011-2012, SpoutDev <http://www.spout.org>

Launcher is licensed under [GNU Lesser General Public License Version 3][License], but with a provision that files are released under the MIT license 180 days after they are published. Please see the `LICENSE.txt` file for details.
...
Compiling
---------
Launcher uses Maven to handle its dependencies.
...
[GitHub]: https://github.com/SpoutDev/Launcher
[Jenkins]: http://build.spout.org/job/Launcher
...
[Donate]: https://www.paypal.com/cgi-bin/webscr?hosted_button_id=QNJH72R72TZ64&item_name=Launcher+donation+%28from+github.com%29&cmd=_s-xclick
