...
What is LauncherAPI?
--------------------
LauncherAPI is the skin and customization API for Spoutcraft Launcher.

Copyright (c) 2011-2012, SpoutDev <http://www.spout.org>

LauncherAPI is licensed under [GNU Lesser General Public License Version 3][License], but with a provision that files are released under the MIT license 180 days after they are published. Please see the `LICENSE.txt` file for details.
...
Compiling
---------
LauncherAPI uses Maven to handle its dependencies.
...
[GitHub]: https://github.com/SpoutDev/LauncherAPI
[Javadoc]: http://jd.spout.org/launcher/
[Jenkins]: http://build.spout.org/job/LauncherAPI
...
[Donate]: https://www.paypal.com/cgi-bin/webscr?hosted_button_id=QNJH72R72TZ64&item_name=LauncherAPI+donation+%28from+github.com%29&cmd=_s-xclick
